...
namespace SajberRoyale.Player
{
    public class DamageController : MonoBehaviourPun
    {
        ...
        public void PlayAudioAtPlayer(int actorID, float range, AudioClip audio, string objname = "Audio", bool loop = false, float volume = 1)
        {
            ...
            audioContainer.GetComponent<AudioSource>().volume = volume;
