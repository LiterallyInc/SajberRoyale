...
namespace SajberRoyale.Player
{
    ...
    public class PlayerManager : MonoBehaviourPun
    {
        ...
        {
            //pickup item
            if (Physics.Raycast(Camera.main.ScreenPointToRay(Input.mousePosition), out RaycastHit hit) && hit.transform.CompareTag("ItemNode") && (Input.GetKeyDown(KeyCode.F) || Input.GetKeyDown(KeyCode.E)) && Game.Game.Instance.IsAlive)
            {
